...
def get_estimator_variance_vary_cost(num_models = 101, fidelity_ladder =[4, 8, 16], base_cost = 50, cost_multiplier = [1,2,4,8,16], log_path = 'plots/estimator_variance_vary_cost.csv'):
    output_vec  = []
    for C in cost_multiplier:
        ...
        for seed in range(num_models):
            ...
            model.train()
            values = sunflower_disk_points(2048)
