    ...
    with torch.no_grad():
        for C in cost_multiplier:
            ...
            for seed in range(num_models):
                ...
                model.train()
                _, mean_estimator_variance, _, sample_variance_estimator_variance = multi_level_multi_fidelity_eval(model, images, labels, fidelity_ladder = fidelity_ladder, num_levels = num_levels)
